...
from .const import ATTR_DEVICE_ID, ENTITY_DEVICE_TIMESTAMP, ATTR_WEBHOOK_RECEIVED_AT, ATTR_WEBHOOK_ID, CONF_DEVICE_TYPE, DEVICE_TYPES, DOMAIN, ENTITY_ACCURACY, ENTITY_ALTITUDE, ENTITY_BATTERY_LEVEL, ENTITY_CHARGE_PORT_CONNECTED, ENTITY_GEAR, ENTITY_HEADING, ENTITY_IGNITION, ENTITY_IS_CHARGING, ENTITY_LATITUDE, ENTITY_LONGITUDE, ENTITY_ODOMETER, ENTITY_POWER, ENTITY_SPEED, ENTITY_TEMPERATURE
